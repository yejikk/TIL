...
def play(conn, gameData):
    angle = 23
    power = 100
    if (gameData.balls[0][0], gameData.balls[0][1]) == (65, 65):
        angle = 47
        power = 91
    elif (gameData.balls[0][0], gameData.balls[0][1]) == (130, 116):
        angle = 20
        power = 100
    elif (gameData.balls[0][0], gameData.balls[0][1]) == (136, 88):
        angle = 70
        power = 120
    else:
        angle = 181
...
api : AIzaSyA4pVophyWGSoXpbs0uulglG8QeF7KN72Y
...
bixby OAuth 클라이언트 ID : 50253654778-dsfjc6l1qf492b86an598c4b5n2lhb3m.apps.googleusercontent.com

비밀번호: Kx9udfQxd2wM2QNOvv0VxRvT
